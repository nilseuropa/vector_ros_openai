...
if __name__ == '__main__':
    ...
    pkg_path = rospack.get_path('my_anki_vector_openai_example')
    ...
    Alpha = rospy.get_param("/anki_vector/alpha")
    Epsilon = rospy.get_param("/anki_vector/epsilon")
    Gamma = rospy.get_param("/anki_vector/gamma")
    epsilon_discount = rospy.get_param("/anki_vector/epsilon_discount")
    nepisodes = rospy.get_param("/anki_vector/nepisodes")
    nsteps = rospy.get_param("/anki_vector/nsteps")

    running_step = rospy.get_param("/anki_vector/running_step")
